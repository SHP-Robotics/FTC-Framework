...
@TeleOp
public class FreshmenDriveCode extends BaseRobotFreshmen {
    ...
    public void init() {
        ...
        drive.setDefaultCommand(
                new RunCommand(
                        () -> drive.fieldOrientatedMecanum(-gamepad1.left_stick_y, -gamepad1.left_stick_x, -gamepad1.right_stick_x)
                )
        );
    }
