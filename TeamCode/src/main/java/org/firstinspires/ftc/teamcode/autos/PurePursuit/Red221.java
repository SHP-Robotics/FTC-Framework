...
public class Red221 extends BaseAuto {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        PurePursuitPath pathFar = new PurePursuitPath.PurePursuitPathBuilder()
                ...
                .moveTo(new Position2D(44+48, 5, Math.toRadians(180)))
                .moveTo(new Position2D(52+48, 5, Math.toRadians(180)))
        ...
        PurePursuitPath pathCenter = new PurePursuitPath.PurePursuitPathBuilder()
                ...
                .moveTo(new Position2D(3, 56, Math.toRadians(-90)))
                .addAction(() -> claw.setPosition(Constants.CLAW_OPEN))
                .moveTo(new Position2D(5, 62, Math.toRadians(-90)))
                .rotateTo(new Position2D(5, 62, Math.toRadians(-90)), Math.toRadians(180))
                .addAction(() -> outtake.setPosition(Constants.OUTTAKE_NEUTRAL))
                ...
                .addAction(() -> outtake.setPosition(Constants.OUTTAKE_HIDDEN))
                .moveTo(new Position2D(44+48, 6, Math.toRadians(180)))
                .moveTo(new Position2D(52+48, 6, Math.toRadians(180)))
        ...
        PurePursuitPath pathClose = new PurePursuitPath.PurePursuitPathBuilder()
                ...
                .addAction(() -> outtake.setPosition(Constants.OUTTAKE_NEUTRAL))
                .moveTo(new Position2D(-5, 60, Math.toRadians(180)))
