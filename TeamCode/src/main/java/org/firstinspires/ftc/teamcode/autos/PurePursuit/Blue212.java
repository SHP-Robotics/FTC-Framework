...
public class Blue212 extends BaseAuto {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        PurePursuitPath pathFar = new PurePursuitPath.PurePursuitPathBuilder()
                ...
                .moveTo(new Position2D(-44-48, 64, Math.toRadians(0)))
                .moveTo(new Position2D(-52-48, 64, Math.toRadians(0)))
        ...
        PurePursuitPath pathClose = new PurePursuitPath.PurePursuitPathBuilder()
                ...
                .moveTo(new Position2D(-46 - 48, 26, Math.toRadians(0)))
                .moveTo(new Position2D(-49 - 48, 26, Math.toRadians(0)))
                .addAction(2, () -> {
                    mecanumController.deactivate();
                    outtake.setPosition(Constants.OUTTAKE_LOWERED);
                    try {
                ...
                .addAction(() -> outtake.setPosition(Constants.OUTTAKE_HIDDEN))
                .moveTo(new Position2D(-44 - 48, 56, Math.toRadians(0)))
                .moveTo(new Position2D(-52 - 48, 56, Math.toRadians(0)))
